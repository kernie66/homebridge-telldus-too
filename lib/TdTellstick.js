...
class TdTellstick extends AccessoryDelegate {
  constructor(platform) {
    ...
    this.manufacturer = 'telldus';
    // this.model =
    //   params.config.modelid + ' / ' + params.config.devicename;
    this.firmware = '0.0.0';
    // this.software = params.config.swversion;
    this.category = platform.Accessory.Categories.BRIDGE;
    ...
    this.log('Access token: %s', this.accessToken);
