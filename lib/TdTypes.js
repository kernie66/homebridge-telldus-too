...
//      maxValue: 3600,
    ...
    this.createCharacteristicClass('Repetition', uuid('Repetition'), {
    ...
    this.createCharacteristicClass('EnableRandomOnce', uuid('EnableRandomOnce'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
    }, 'Enable random once')

    this.createCharacteristicClass('DisableRandomOnce', uuid('DisableRandomOnce'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
    }, 'Disable random once')

    this.createCharacteristicClass('Disabled', uuid('Disabled'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
    }, 'Disabled')

    this.createCharacteristicClass('Status', uuid('Status'), {
      format: this.Formats.STRING,
      perms: [this.Perms.READ, this.Perms.NOTIFY]
    }, 'Status')

    this.createCharacteristicClass('LastActivation', uuid('LastActivation'), {
      format: this.Formats.STRING,
      perms: [this.Perms.READ, this.Perms.NOTIFY]
    }, 'Last activation')
  }
