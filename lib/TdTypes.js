...
//      maxValue: 3600,
    ...
    this.createCharacteristicClass('SetRandomOnce', uuid('0AB'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
    }, 'Set random once')

    this.createCharacteristicClass('Status', uuid('0AA'), {
      format: this.Formats.STRING,
      perms: [this.Perms.READ, this.Perms.NOTIFY]
    }, 'Status')

    this.createCharacteristicClass('LastActivation', uuid('0AC'), {
      format: this.Formats.STRING,
      perms: [this.Perms.READ, this.Perms.NOTIFY]
    }, 'Last activation')
  }
