...
class TdPlatform extends homebridgeLib.Platform {
  constructor(log, configJson, homebridge) {
    ...
    if (!this.config.ipAddress) {
      ...
      this.newApi = new TelldusApi(this.config.ipAddress, this.config.accessToken)
      this.log('New API URL:', this.newApi.getUrl);
    }
  ...
  async init(beat) {
    ...
    try {
      let sysInfo = await this.newApi.getSystemInfo();
      this.log('Telldus system info:', sysInfo.data);
