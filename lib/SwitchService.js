    ...
    this.addCharacteristicDelegate({
      ...
      .on('didSet', (value) => {
        if (!this.values.disabled || !this.values.enabled) {
          ...
          this.log(
            'Switch constantly disabled/enabled, deactivate it to be able to turn it on!'
          );
        }
      })
      .on('didTouch', (value) => {
        if (!this.values.disabled || !this.values.enabled) {
          ...
          this.log(
            'Switch constantly disabled/enabled (touched), deactivate it to be able to turn it on!'
          );
        }
      });
