...
class SwitchService extends homebridgeLib.ServiceDelegate {
  constructor(switchAccessory, params = {}) {
    ...
    this.addCharacteristicDelegate({
      key: 'setRandomOnce',
      value: false,
      Characteristic: this.td.Characteristics.SetRandomOnce,
    })
  ...
  async setOn(switchAccessory) {
    ...
    this.onUpdated = true
    await wait(50)
    const randomDelay = this.values.setRandomOnce ? true : this.values.random
    this.values.setRandomOnce = false
